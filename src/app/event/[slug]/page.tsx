...
export default async function EventPage({ params }: Props) {
  ...
  return (
    <main>
      <section className="relative overflow-hidden flex justify-center items-center py-14 md:py-20">
        ...
        <div className="z-1 flex flex-col gap-6 lg:gap-16 lg:flex-row relative">
          ...
          <div className="flex flex-col ">
            ...
            <button className="bg-white/20 text-lg bg-blur border-white/10 border-2 rounded-md capitalize mt-5 lg:mt-auto w-[95vw] sm:w-full py-2 state-effects">
              Get Tickets
            </button>
          </div>
        </div>
      ...
      <div className="min-h-[75h] text-center px-5 py-16">
        <Section>
